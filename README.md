...
Collection of very experimental utilities to modify existing MSTS/ORTS track shapes. Things are subject to change and may not work as expected all the time (not yet anyway).
